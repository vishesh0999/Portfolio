            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              <div className="flex flex-col justify-center items-center space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-md">
                  ...
                  <button className="flex items-center justify-center px-6 py-4 bg-accent-400 text-white rounded-xl font-grotesk font-bold hover:bg-accent-500 transition-colors shadow-lg hover:shadow-xl transform hover:scale-105 duration-200">
                  ...
                  <button className="flex items-center justify-center px-6 py-4 bg-gray-700 text-white rounded-xl font-grotesk font-bold hover:bg-gray-800 transition-colors shadow-lg hover:shadow-xl transform hover:scale-105 duration-200">
                    <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {/* GitHub Repo Button */}
                <button className="flex items-center justify-center px-8 py-4 bg-gray-900 text-white rounded-xl font-grotesk font-bold hover:bg-black transition-colors shadow-lg hover:shadow-xl transform hover:scale-105 duration-200 w-full max-w-md">
